...
// Tomcat / RestEasy 3.9.x / Servlet 2.x Example
@Path("/example")
public class ExampleResource {
    ...
    public Response imageFileUpload(@MultipartForm FormModel form) {
        String fileName = "temp_" + Math.random();
        String filePath = "/Users/seanazlin/IdeaProjects/jaxrs/" + fileName;
        try {
            FileUtils.writeByteArrayToFile(new File(filePath), form.getBytes());
        } catch (IOException e) {
            e.printStackTrace();
        }
